...
namespace Lab_Alg_1
{
    public static class TextInterface
    {
        ...
        static string listAlgorithms = "1 Постоянная функция\n" +
                ...
                "7 TimSort\n" +
                "8.1 Простое возведение в степень (шаги)\n" +
                "8.2 Рекурсивное возведение в степень (шаги)\n" +
                "8.3 Быстрое возведение в степень (шаги)\n" +
                "8.4 Классическое быстрое возведение в степень (шаги)\n" +
